# 14-Week Career Transition: IT Support to Full-Stack Cloud DevOps Engineer
...
│   ├── sql-learning-plan.md           # SQL from basics to advanced
│   ├── azure-az204-plan.md            # AZ-204 exam preparation
│   ├── devops-learning-plan.md        # DevOps & CI/CD mastery
│   ├── books-reading-plan.md          # 14-week reading schedule
│   └── weekly-goals.md                # Week-by-week objectives
├── projects/
│   ├── week1-task-manager/            # Week 1: Simple CRUD app
│   ├── project1-asset-management/     # Weeks 3-4: IT Asset Management
│   ├── project2-infrastructure/       # Weeks 5-6: Provisioning Platform
│   └── project3-portfolio/            # Week 7: Personal Portfolio
├── resources/
│   ├── cheat-sheets/                  # Quick reference guides
│   ├── templates/                     # Code templates
│   └── architecture-diagrams/         # System design diagrams
├── progress/
│   ├── week1-review.md                # Weekly retrospectives
│   ├── week2-review.md
│   └── ...
└── certifications/
    ├── az-204-notes.md                # Exam preparation notes
    └── practice-exams/                # Practice test results
```
...
12. **"Exam Ref AZ-204"** - Microsoft Press

**Reading Schedule:** 1 hour/day = 10-12 books in 14 weeks
...
**[View Study Plan →](plans/azure-az204-plan.md)**
...
**[Complete Week 1 Guide →](plans/week1-daily-guide.md)**
...
Found a typo? Have a suggestion? Want to share your progress?

1. Fork this repository
2. Create a branch (`git checkout -b improvement/amazing-addition`)
3. Commit changes (`git commit -m 'Add amazing addition'`)
4. Push to branch (`git push origin improvement/amazing-addition`)
...
Feel free to use this plan for your own career transition!
...
- Inspired by countless developers who shared their journey
- Built on the shoulders of open-source community
- Motivated by the dream of a better career
...
- Career transition stories on Reddit, Hacker News, Dev.to
...
- [Week 1 Day-by-Day Guide](plans/week1-daily-guide.md)
- [Weekly Goals Tracker](plans/weekly-goals.md)
- [Books Reading Plan](plans/books-reading-plan.md)
...
- Share your progress with #100DaysOfCode
- Join [r/learnprogramming](https://reddit.com/r/learnprogramming)
- Connect on [r/devops](https://reddit.com/r/devops)
- Follow [r/cscareerquestions](https://reddit.com/r/cscareerquestions)

---

**"The best time to start was yesterday. The next best time is now."**

**Start Week 1 today. Your future self will thank you. 🚀**
